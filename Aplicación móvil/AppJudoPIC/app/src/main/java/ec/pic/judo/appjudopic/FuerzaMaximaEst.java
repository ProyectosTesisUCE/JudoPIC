...
import ec.pic.judo.appjudopic.modelo.Constantes;
...
public class FuerzaMaximaEst extends AppCompatActivity implements Response.Listener<JSONObject>, Response.ErrorListener, AdapterView.OnItemSelectedListener{
    ...
    private void llenarSpinner(){
        ...
        String url2= cons.historicos_deportista+user;
    ...
    private void cargarWebService() {
        ...
        String url= cons.estadistica_deportista+user+cons.registro+seleccion;
